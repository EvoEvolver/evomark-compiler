...
import { evomark_tokenizer, get_close_tag, get_open_tag, get_tag_pair, token, tokeniz_rule_func } from "../tokenize";
...
export function list(core: evomark_core){
    ...
    core.tokenizer.add_func_rule(new tokeniz_rule_func("list", tokenize))
